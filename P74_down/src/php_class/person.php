...
class Person
{
    ...
    function takeJob(\src\functions\Job $job) {
        echo "Now employed as a {$job->title}\n";
    }

    function bestJob(): \src\functions\Job {
...
class SupernaturalPerson extends \src\php_class\Person {
    public function incrementAge() {
        // ages in reverse
        $this->decrementAge();
    }
...
$o = new \src\php_class\Person;
$a = (array) $o;
// print_r($a);

$person = new \src\php_class\Person;
$person->incrementAge();
...
echo \src\php_class\Person::$global. "\n";
